# IEEE_Milestone_Lions_Commentary

In consultation with Ambarish Natu (IEEE ACT Section), Paul Leopardi is
currently working to finalize an **IEEE Milestone proposal** to formally
recognize John Lions' 1977 work at UNSW, *A Commentary on the Sixth Edition
...
so that it can be merged with the version on Github.
